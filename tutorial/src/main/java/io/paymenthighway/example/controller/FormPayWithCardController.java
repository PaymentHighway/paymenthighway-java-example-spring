...
public class FormPayWithCardController extends PaymentHighway {
  ...
  public String success(@RequestParam Map<String,String> requestParams, Model model) throws Exception {
    ...
    /**
     * Make a commit server-to-server request using the PaymentApi in order to get the card details,
     * or the error result if the payment was rejected.
     *
     * The transaction must be committed with the same or smaller amount as initialized!
     *
