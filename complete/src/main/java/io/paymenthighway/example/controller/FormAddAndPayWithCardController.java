...
@Controller
public class FormAddAndPayWithCardController extends PaymentHighwayController {
  ...
  @RequestMapping(value="/add_and_pay_with_card", method=RequestMethod.GET)
  ...
  @RequestMapping(value="/add_and_pay_with_card/success", method=RequestMethod.GET)
  ...
  @RequestMapping(value="/add_and_pay_with_card/failure", method=RequestMethod.GET)
  ...
  @RequestMapping(value="/add_and_pay_with_card/cancel", method=RequestMethod.GET)
